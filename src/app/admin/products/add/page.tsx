...
import { useProductsAdd } from "../_services/product-hooks";
import { useAllCategories } from "../../categories/_servicecs/category-hooks";
...
export default function AddProductPage() {
  const { form, onSubmit, isPending } = useProductsAdd();
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[32px] border border-black/5 bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl">Add product</h1>
